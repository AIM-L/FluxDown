...
[**官网**](https://fluxdown.app) · [**下载**](https://fluxdown.app/#download) · [**更新日志**](https://fluxdown.app/changelog) · [**常见问题**](https://fluxdown.app/faq) · [**反馈**](https://fluxdown.app/feedback)
...
- 🌐 **多协议支持** —— HTTP/HTTPS、FTP、BitTorrent、HLS 与 DASH 流媒体
...
| 🔗 | **多协议** | HTTP/HTTPS、FTP、BitTorrent（DHT/UPnP/磁力）、HLS（AES 解密）、DASH 专属引擎 |
| 🎚️ | **速度控制** | Token bucket 全局限速 —— 后台下载不影响正常上网 |
| 🔄 | **随处续传** | 每个字节都记录在 SQLite（WAL 模式），断电也不丢进度 |
| 🧩 | **浏览器集成** | 三层下载拦截、流媒体资源嗅探、Alt+Click 绕过、右键发送 |
| 🖥️ | **精美界面** | shadcn 风格组件、IDM 式分段可视化、命名队列、系统托盘 |
| 🕊️ | **干净纯粹** | 零广告、零追踪、无账号 —— 数据完全留在本地 |
...
从 [**GitHub Releases**](https://github.com/zerx-lab/FluxDown/releases/latest) 或 [**fluxdown.app**](https://fluxdown.app/#download) 获取最新版本：
...
- 💬 **QQ 群** —— [832143651](https://fluxdown.app/qq-group)
- 🗳️ **功能投票** —— [fluxdown.app/vote](https://fluxdown.app/vote)
...
**如果 FluxDown 帮你省下了时间，欢迎点个 ⭐ —— 让更多人发现这个项目。**

Made with 🦀 + 💙 by [zerx-lab](https://github.com/zerx-lab)
